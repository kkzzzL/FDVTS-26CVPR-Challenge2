...
from models.resnet_xjl import ResNet, Bottleneck, ResNet3D, Bottleneck3D, ResNet3D_VPT
...
#@RESNEST_MODELS_REGISTRY.register()
def resnest50_3D(pretrained=True, ipt_dim=3, root='~/.encoding/models', **kwargs):
    ...
    model_3d = ResNet3D_VPT(model, Bottleneck3D, [3, 4, 6, 3], ipt_dim=ipt_dim,
                   radix=2, groups=1, bottleneck_width=64,
                   deep_stem=True, stem_width=32, avg_down=True,
                   avd=True, avd_first=False, **kwargs)
    return model_3d
